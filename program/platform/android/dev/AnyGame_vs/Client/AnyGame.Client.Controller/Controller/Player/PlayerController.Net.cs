...
var p1 = new AnyGame.Client.Entity.Guide.GuideTypes[len1];for(int i =0;i< len1;i++){
...
var len1 = reader.ReadInt32();
var p1 = new AnyGame.Client.Entity.Character.MenuTypes[len1];for(int i =0;i< len1;i++){
