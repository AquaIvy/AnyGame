...
namespace DogSE.Server.Database.MongoDB
{
    ...
    public class MongoDBLogService
    {
        ...
        public int InsertEntity<T>(T entity) where T : class, new()
        {
            ...
            var proMongoDB = MongoDBService.MongoDB.Instance;

            try
            {
                profile.Insert.TotalCount++;
                proMongoDB.Insert.TotalCount++;
            ...
            finally
            {
                ...
                proMongoDB.Insert.TotalTime += profile.Load.Watch.ElapsedTicks;
            }
        }
