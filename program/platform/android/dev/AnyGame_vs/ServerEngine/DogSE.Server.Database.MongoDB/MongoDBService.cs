...
namespace DogSE.Server.Database.MongoDB
{
    ...
    public class MongoDBService : IDataService
    {
        ...
        public MongoDBService(string host, string database)
        {
            _host = host;
            _database = database;
        }
        ...
        public T LoadEntity<T>(int serial) where T : class, IDataEntity, new()
        {
            ...
            var proMongoDB = MongoDB.Instance;

            try
            {
                profile.Load.TotalCount++;
                proMongoDB.Load.TotalCount++;
            ...
            finally
            {
                ...
                proMongoDB.Load.TotalTime += profile.Load.Watch.ElapsedTicks;
            }
        }
        ...
        public T[] SeachEntityByName<T>(string where, int page = 0, int pageSize = 10) where T : class, IDataEntity, new()
        {
            ...
            var proMangoDB = MongoDB.Instance;
        ...
        private class UpdateEntityPool<T> where T : class, IDataEntity, new()
        {
            ...
            public static UpdateEntityPool<T> AcquireContent(MongoDBService db, T entity)
            {
        ...
        public class MongoDB : DBEntityProfile<MongoDB>
        {
